            ...
            <div className='m-8'>
                <div className="p-16 bg-bg-green border-[#00BD7A40] rounded-3xl border">
                    <div className="text-deep-green font-bold text-center">
                        <p className='text-2xl'>Utilities Bill</p>
                        <p className="text-gray-700 text-xl font-thin w[360px]">Choose a government approved document</p>
                    </div>
                    <div className='w-[350px] mt-6'>
                        <form>
                            ...
                            >
                                <option value="">Choose utilities bill</option>
                                <option value="drivers-license">Water Bill</option>
                                <option value="nin-id">NEPA Bill</option>
                                <option value="int-passport">Waste Management Bill</option>
                            </select>

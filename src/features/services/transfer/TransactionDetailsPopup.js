    ...
    <div className="relative">
      {isVisible && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 text-center">
          <div className="bg-white p-4 rounded-md md:w-[400px] h-[350px] md:w-[400px] absolute md:top-4/5 top-[200px] md:left-[45%] left-2/5">
            ...
            <div className="mb-4">
              ...
              <p>TRF: {transactionDetails.account}</p>
